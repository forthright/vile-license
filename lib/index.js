...
var npm_licenses = function npm_licenses(is_allowed, pkg_is_ignored) {
  return new Promise(function (resolve, reject) {
    ...
    npm_license.init({ start: process.cwd() }, function (err, json) {
...
var partially_matches = function partially_matches(pattern, license_txt) {
  return new RegExp(pattern, "ig").test(license_txt);
};
  ...
  var is_allowed = function is_allowed(list) {
    return _.some(list, function (l) {
      return _.some(allowed, function (match) {
        return partially_matches(match, l);
      });
